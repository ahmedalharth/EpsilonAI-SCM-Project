...
# VARIABLES #
# Paths
primary_data = 'SCM APP/Data/SCM_Dataset_Updated_with_Green_Logistics.xlsx'
clean_data_path = 'SCM APP/Data/Clean_df.csv'
train_path = 'SCM APP/Data/Train.csv'
test_path = 'SCM APP/Data/Test.csv'
# images
icon_image = Image.open('SCM APP/Images/SCM_icon.webp')
